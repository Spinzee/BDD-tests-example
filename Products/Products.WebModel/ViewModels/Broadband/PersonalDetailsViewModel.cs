...
namespace Products.WebModel.ViewModels.Broadband
{
    public class PersonalDetailsViewModel : BaseViewModel
    {
        ...
        [AriaDescription(ResourceType = typeof(PersonalDetails_Resources), Name = "TitleAriaDescription")]
        ...
        [Range(1, int.MaxValue, ErrorMessageResourceType = typeof(Form_Resources), ErrorMessageResourceName = "TitlesError")]
        [LocalisedDescription("Title")]
        [EnumDataType(typeof(Titles))]
        public Titles Titles { get; set; }

        [AriaDescription(ResourceType = typeof(PersonalDetails_Resources), Name = "FirstNameAriaDescription")]
        ...
        [AriaDescription(ResourceType = typeof(PersonalDetails_Resources), Name = "LastNameAriaDescription")]
        ...
        [AriaDescription(ResourceType = typeof(PersonalDetails_Resources), Name = "DateOfBirthDayAriaDescription")]
        [Required(ErrorMessageResourceType = typeof(Form_Resources), ErrorMessageResourceName = "DateOfBirthRequiredError")]
        ...
        [AriaDescription(ResourceType = typeof(PersonalDetails_Resources), Name = "DateOfBirthMonthAriaDescription")]
        [Required(ErrorMessageResourceType = typeof(Form_Resources), ErrorMessageResourceName = "DateOfBirthRequiredError")]
        [LocalisedDescription("DateOfBirth")]
        ...
        [AriaDescription(ResourceType = typeof(PersonalDetails_Resources), Name = "DateOfBirthYearAriaDescription")]
        [Required(ErrorMessageResourceType = typeof(Form_Resources), ErrorMessageResourceName = "DateOfBirthRequiredError")]
        [LocalisedDescription("DateOfBirth")]
